...
<section class="es-form-area">
    <div class="card">
        ...
        <div class="session_view_link ml-3 mt-4 mb-5">
            <a href="add_account_head.html" class="btn btn-primary"><i class="fa-solid fa-plus"></i></a>
            <a href="account_head_view.html" class="btn btn-primary"><i class="fa-solid fa-eye"></i></a>
        </div>

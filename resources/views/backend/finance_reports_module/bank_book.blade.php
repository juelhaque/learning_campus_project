    ...
    <section class="es-form-area">
        <div class="card">
            <header class="card-header bg-gradient border-0 pt-5 pb-5 d-flex align-items-center">
                <h2 class="text-white mb-0">Bank Book</h2>
            </header>
                ...
                <div class="table-responsive attendenceTable account_ledger_table py-5">
                    <div class="container">
                        ...
                        <div class="text-center studentDuesTop">
                            ...
                            <p>Uttara, Dhaka</p>
                            <p>Bank Book for the month of April 2021</p>
                        </div>
                        <table class="table table-bordered table-striped text-center">
                            <thead>
                                <tr class="th_color">
                                    <th scope="col">Deposit / Receive</th>
                                    <th scope="col">Withdraw / Payment</th>
                                </tr>
                            </thead>
                            <tbody>
                                    ...
                                    <td>
                                        <table class="table table-bordered table-striped text-center">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>2021-04-01</td>
                                                    <td>27.00 - Janata Bank</td>
                                                    <td>15,000.00</td>
                                                </tr>
                                                <tr>
                                                    <td>2021-04-01</td>
                                                    <td>26.00 - Sonali Bank</td>
                                                    <td>12,000.00</td>
                                                </tr>
                                                <tr>
                                ...
                                <tr>
                                    <td colspan="2" class="text-right">Balance : 21,400.00</td>
                                </tr>

                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10 mb-3">
                                    ...
                                    <select name="medium_name" id="" required>
                                        <option value="bangla_medium" {{ $shift_data->medium_name == 'bangla_medium' ? 'selected' : '' }} >Bangla Medium</option>
                                        <option value="english_medium" {{ $shift_data->medium_name == 'english_medium' ? 'selected' : '' }} >English Medium</option>
                                    </select>
                                </div>

        ...
        <div class="card-body table-responsive" id="institue">
            <form action="" class="es-form es-add-form">
                <div class="session_view_link mt-2 mb-5">
                    <a href="add_group.html" class="btn btn-primary"><i class="fa-solid fa-plus"></i></a>
                    <a href="group_edit.html" class="btn btn-primary"><i class="fa-solid fa-pencil"></i></a>
                </div>
                <!---- Session View table  ----->

<header class="u-header">
    <div class="u-header-left">
        <a class="u-header-logo" href="{{route('dashboard')}}">
            <img class="u-logo-desktop" src="{{ asset('AdminAssets/Logo _ Icon/logo.png') }}" width="180px" alt="Stream Dashboard">
        </a>
    </div>
    ...
    <div class="u-header-middle">
        ...
        <div class="most_usefull_link">
            ...
            <a href="manual_attentence.html" data-toggle="tooltip bg-dark" data-placement="top"
                title="Manual Attendance"><i class="fa-solid fa-user-xmark"></i></a>
            <a href="create_routine.html" data-toggle="tooltip bg-dark" data-placement="top"
                title="Create Routine"><i class="fa-solid fa-download"></i></a>
            ...
            <a href="add_live_class.html" data-toggle="tooltip bg-dark" data-placement="top"
                title="Add Live Class"><i class="fa-solid fa-video"></i></a>
    ...
    <div class="u-header-right">
                            ...
                            <a class="list-group-item list-group-item-action" href="#">
                                <div class="media align-items-center">
                                    <img class="u-avatar--sm rounded-circle mr-3"
                                        src="AdminAssets/img/avatars/img1.png" alt="Image description">
        ...
        <div class="dropdown mr-3">
            ...
            <div class="dropdown-menu dropdown-menu-right border-0 py-0 mt-4" aria-labelledby="dropdownMenuLink">
                <div class="card">
                    ...
                    <div class="card-footer py-3">
                        <a class="btn btn-block btn-outline-primary" href="manage_live_class.html">View all Live
                            Class</a>
                    </div>
                </div>
            </div>
        ...
        <div class="dropdown ml-2">
            <a class="link-muted d-flex align-items-center us-u-avatar-wrap" href="#!" role="button"
                ...
                <img class="u-avatar--xs rounded-circle mr-2 bg-gradient" src="{{Avatar::create(Auth::user()->name)->toBase64();}}"
                    alt="User Profile">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="mb-4">
                                <a class="d-flex align-items-center link-dark" href="{{route('profile.edit')}}">
                                    <span class="h3 mb-0"><i class="fa-solid fa-lock mr-2"></i> </span>Profile
                                </a>
                            </li>
                            ...
                            <li class="mb-4">
                                    <form method="POST" action="{{ route('logout') }}">
                                        ...
                                        <x-dropdown-link :href="route('logout')" onclick="event.preventDefault();
                                            ...
                                            <span class="h3 mb-0 pl-0"><i class="fa-solid fa-right-from-bracket"></i></span> {{ __('Log Out') }}
                                        </x-dropdown-link>
                                    </form>

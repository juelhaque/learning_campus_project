    ...
    <section class="es-form-area">
        <div class="card">
            <header class="card-header bg-gradient border-0 pt-5 pb-5 d-flex align-items-center">
                <h3 class="text-white mb-0">
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link active" href="javascript:void(0)" onclick="institue()">General
                                Information</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white" href="javascript:void(0)" onclick="general()">Chart
                                Information</a>
                        </li>
                    </ul>
                </h3>
            ...
            <div class="session_view_link ml-3 mt-4 mb-5">
                ...
                <a href="{{ route('employee-payscale.view')}}" class="btn btn-primary"><i class="fa-solid fa-eye"></i></a>
            </div>
                ...
                <form action class="es-form es-add-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                            <label for="subject">Pay Scale Title
                                <span>*</span></label>
